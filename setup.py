...
def main():
    ...
    # if _KGEN_LANG_SETUP_SKIP_PLUGGY_DEP is set, skip installing pluggy;
    # used by tox.ini to test with pluggy master
    if '_KGEN_LANG_SETUP_SKIP_PLUGGY_DEP' not in os.environ:
    ...
    setup(
        name='kgen_lang',
        description='kgen_lang: Automated code extraction tool',
        long_description=long_description,
        use_scm_version={
            'write_to': '_kgen_lang/_version.py',
        },
        url='http://kgenlang.org',
        license='MIT license',
        ...
        packages=['_kgen_lang'],
        py_modules=['kgen_lang'],
        zip_safe=False,
    )


class KGenLang(Command):
    user_options = []
    ...
    def run(self):
        ...
        errno = subprocess.call([sys.executable, 'kgen_lang.py', '--ignore=doc'])
